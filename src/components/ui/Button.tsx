...
export default function Button({ 
  ...
  const variantClasses: Record<ButtonVariant, string> = {
    primary: 'bg-[#171717] text-[#fafafa] hover:bg-[linear-gradient(90deg,rgba(255,255,255,0.1)_0%,rgba(255,255,255,0.1)_100%),linear-gradient(90deg,#171717_0%,#171717_100%)] active:bg-[#171717]/75 active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#a3a3a3] focus-visible:ring-offset-2 focus-visible:shadow-[0px_0px_0px_3px_rgba(163,163,163,0.5)] disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-[#171717] disabled:active:scale-100 font-medium leading-5 transition-all duration-150',
    secondary: 'bg-white border border-[#e5e5e5] border-solid text-[#0a0a0a] hover:bg-[#f5f5f5] hover:shadow-[0px_1px_2px_0px_rgba(10,13,18,0.05)] active:bg-[#e5e5e5] active:shadow-none active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#a3a3a3] focus-visible:ring-offset-2 focus-visible:border-[#a3a3a3] focus-visible:shadow-[0px_0px_0px_3px_rgba(163,163,163,0.5)] disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-white disabled:hover:shadow-none disabled:active:scale-100 font-medium leading-5 transition-all duration-150',
