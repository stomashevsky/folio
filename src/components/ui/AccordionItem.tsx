...
export default function AccordionItem({
  ...
  return (
    <button
      ...
      className="group border-b border-[#e5e5e5] border-l-0 border-r-0 border-t-0 border-solid flex flex-col items-start p-0 relative shrink-0 w-full outline-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#a3a3a3] focus-visible:ring-offset-2 cursor-pointer transition-colors duration-150"
    >
