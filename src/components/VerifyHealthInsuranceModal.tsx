    ...
    <>
      {!isVerifiedModalOpen && (
        <ModalShell
          isOpen={isOpen}
          onClose={onClose}
          title={t('playground.modals.verify.healthInsurance.title')}
          description={t('playground.modals.verify.healthInsurance.description')}
          size="small"
          ...
          <div className="flex flex-col gap-10 items-start w-full">
            <div className="flex flex-col gap-4 items-start w-full">
              <div className="flex flex-col gap-2 items-start w-full">
                <label htmlFor="requester-name-health-insurance" className="font-medium leading-5 text-sm text-[#0a0a0a]">
                  {t('playground.modals.fields.requesterName')}
                </label>
                <TextInput
                  id="requester-name-health-insurance"
            ...
            <div className="flex flex-col gap-4 items-start w-full">
              ...
              />
              <Switch
                label={t('playground.modals.fields.coverageType')}
