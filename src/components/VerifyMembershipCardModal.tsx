...
export default function VerifyMembershipCardModal({ isOpen, onClose }: VerifyMembershipCardModalProps) {
    ...
    <>
      {!isVerifiedModalOpen && (
        <ModalShell
          isOpen={isOpen}
          onClose={onClose}
          title={t('playground.modals.verify.membershipCard.title')}
          description={t('playground.modals.verify.membershipCard.description')}
          size="small"
          ...
          <div className="flex flex-col gap-10 items-start w-full">
            <div className="flex flex-col gap-4 items-start w-full">
              <div className="flex flex-col gap-2 items-start w-full">
                <label htmlFor="requester-name-membership-card" className="font-medium leading-5 text-sm text-[#0a0a0a]">
                  {t('playground.modals.fields.requesterName')}
                </label>
                <TextInput
                  id="requester-name-membership-card"
