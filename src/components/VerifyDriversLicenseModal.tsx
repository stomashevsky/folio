    ...
    <>
      {!isVerifiedModalOpen && (
        <ModalShell
          isOpen={isOpen}
          onClose={onClose}
          title={t('playground.modals.verify.driversLicense.title')}
          description={t('playground.modals.verify.driversLicense.description')}
          size="small"
          ...
          <div className="flex flex-col gap-10 items-start w-full">
            <div className="flex flex-col gap-4 items-start w-full">
              <div className="flex flex-col gap-2 items-start w-full">
                <label htmlFor="requester-name-drivers-license" className="font-medium leading-5 text-sm text-[#0a0a0a]">
                  {t('playground.modals.fields.requesterName')}
                </label>
                <TextInput
                  id="requester-name-drivers-license"
            ...
            <div className="flex flex-col gap-4 items-start w-full">
              ...
              />
              <Switch
                label={t('playground.modals.fields.categories')}
                checked={switches.categories}
                onChange={(checked) => handleSwitchChange('categories', checked)}
              />
              <Switch
                label={t('playground.modals.fields.restrictions')}
