  ...
  return (
    <div className="flex flex-col items-start min-h-screen relative w-full">
      ...
      <main className="flex-1 w-full">
        <section className="bg-white flex flex-col gap-6 md:gap-12 items-center px-0 pt-32 md:pt-[164px] pb-16 md:pb-24 relative shrink-0 w-full">
          <div className="flex flex-col gap-12 items-start justify-center px-6 md:px-6 py-0 relative shrink-0 w-full max-w-[768px]">
            ...
            {/* Title and subtitle */}
            <div className="flex flex-col gap-6 items-center relative shrink-0 text-center w-full whitespace-pre-wrap">
            ...
            <div className="flex flex-col gap-6 items-start relative shrink-0 w-full">
              ...
              <h2 className="pt-8 px-0 font-semibold leading-9 text-[30px] text-[#0a0a0a] relative shrink-0 w-full whitespace-pre-wrap">
