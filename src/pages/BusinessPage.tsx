    ...
    <div className="flex flex-col items-start relative w-full">
      ...
      <section className="flex flex-col gap-6 items-center overflow-hidden px-0 py-16 md:py-24 relative shrink-0 w-full" style={BACKGROUND_STYLE}>
        ...
        <div className="hidden md:flex flex-col gap-16 items-start justify-center max-w-[1280px] px-6 py-0 relative shrink-0 w-full">
          <div className="flex flex-col gap-12 items-start relative shrink-0 w-full">
            <SectionHeader
              title={t('business.trust.title')}
              description={t('business.trust.description')}
              align="left"
              maxWidth="576px"
            />
            <div className="flex gap-8 items-start relative shrink-0 w-full">
              <StatItem
                value={t('business.trust.rating.value')}
                description={t('business.trust.rating.description')}
              />
              <StatItem
                value={t('business.trust.documents.value')}
                description={t('business.trust.documents.description')}
              />
              <StatItem
                value={t('business.trust.countries.value')}
                description={t('business.trust.countries.description')}
              />
            </div>
          </div>
        </div>
      ...
      <section className="bg-white flex flex-col gap-6 items-center overflow-hidden px-0 py-16 md:py-24 relative shrink-0 w-full">
        ...
        <div className="hidden md:flex gap-16 items-center max-w-[1280px] px-6 py-0 relative shrink-0 w-full">
          ...
          <div className="flex flex-1 flex-col gap-8 items-start relative min-w-0">
            <SectionHeader
              title={t('business.format.title')}
              description={t('business.format.description')}
              align="left"
              maxWidth="100%"
            />
            <div className="flex flex-col gap-3 items-start relative shrink-0 w-full">
              <FeatureListItem text={t('business.format.features.noFormats')} />
              <FeatureListItem text={t('business.format.features.fastDelivery')} />
              <FeatureListItem text={t('business.format.features.anySystem')} />
            </div>
          </div>
        </div>
      ...
      <section className="flex flex-col gap-6 items-center overflow-hidden px-0 py-24 relative shrink-0 w-full" style={BACKGROUND_STYLE}>
        <div className="flex flex-col gap-16 items-start justify-center max-w-[1280px] px-6 py-0 relative shrink-0 w-full">
          <div className="flex flex-col gap-10 items-center relative shrink-0 w-full">
            <SectionHeader
              title={t('business.whyFolio.title')}
              description={t('business.whyFolio.description')}
              maxWidth="576px"
            />
            <div className="flex flex-col sm:grid sm:grid-cols-2 lg:grid-cols-4 gap-6 items-start sm:items-stretch justify-center w-full min-w-0">
              <ToolCard
                icon={codeXmlIcon}
                title={t('business.whyFolio.noFormats.title')}
                description={t('business.whyFolio.noFormats.description')}
              />
              <ToolCard
                icon={sendIcon}
                title={t('business.whyFolio.workflow.title')}
                description={t('business.whyFolio.workflow.description')}
              />
              <ToolCard
                icon={calendarFoldIcon}
                title={t('business.whyFolio.onePlace.title')}
                description={t('business.whyFolio.onePlace.description')}
              />
              <ToolCard
                icon={globeIcon}
                title={t('business.whyFolio.everyone.title')}
                description={t('business.whyFolio.everyone.description')}
              />
            </div>
          </div>
        </div>
      ...
      <section className="bg-white flex flex-col gap-6 items-center overflow-hidden px-0 py-16 md:py-24 relative shrink-0 w-full">
        ...
        <div className="hidden md:flex gap-16 items-center max-w-[1280px] px-6 py-0 relative shrink-0 w-full">
          <div className="flex flex-1 flex-col gap-12 items-start relative min-w-0">
            <SectionHeader
              title={t('business.operators.title')}
              description={t('business.operators.description')}
              align="left"
            />
            <div className="flex flex-col gap-8 items-start relative shrink-0 w-full">
              <OperatorListItem
                icon={ticketIcon}
                title={t('business.operators.events.title')}
                description={t('business.operators.events.description')}
              />
              <OperatorListItem
                icon={routeIcon}
                title={t('business.operators.transport.title')}
                description={t('business.operators.transport.description')}
              />
              <OperatorListItem
                icon={cameraIcon}
                title={t('business.operators.tours.title')}
                description={t('business.operators.tours.description')}
              />
            </div>
          </div>
          <ImageWithPlaceholder
            src={ticketIssuanceOperators}
            alt={t('business.operators.title')}
            className="absolute inset-0 max-w-none object-center object-cover rounded-2xl w-full h-full"
            containerClassName="flex-1 min-h-0 min-w-0 relative rounded-2xl aspect-[240/240]"
            loading="lazy"
          />
