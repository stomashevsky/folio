...
export default function BestAppsToPlanTravelArticlePage() {
  ...
  return (
    ...
    >
      ...
      <ArticleParagraph>
        <Trans i18nKey="articles:best-apps-to-plan-travel.p6" components={[<LocalizedLink key="0" to="/#get-the-app" className="underline hover:text-[#737373] transition-colors">Folio</LocalizedLink>]} />
      </ArticleParagraph>
