...
export default function BestDigitalWalletAppsInCanadaArticlePage() {
  return (
    ...
    >
      ...
      <ArticleH2>Key features to look for in a digital wallet</ArticleH2>
      ...
      <ArticleH2>Top digital wallet apps in Canada</ArticleH2>
      ...
      <ArticleH2>Security and privacy considerations</ArticleH2>
      ...
      <ArticleH2>Pros and cons of digital wallets in Canada</ArticleH2>
