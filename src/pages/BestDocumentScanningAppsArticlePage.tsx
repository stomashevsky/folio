...
export default function BestDocumentScanningAppsArticlePage() {
  ...
  return (
    ...
    >
      ...
      <ArticleParagraph>
        <Trans i18nKey="articles:best-document-scanning-apps.p5" components={[<LocalizedLink key="0" to="/wallet#get-the-app" className="underline hover:text-[#737373] transition-colors">Folio</LocalizedLink>]} />
      </ArticleParagraph>
