          ...
          <div className="flex flex-col gap-12 items-start justify-center px-6 md:px-6 py-0 relative shrink-0 w-full max-w-[768px]">
            ...
            <div className="flex flex-col gap-6 items-start relative shrink-0 w-full">
              <p className="font-normal leading-6 relative shrink-0 text-[#0a0a0a] text-base w-full whitespace-pre-wrap">
                TripIt has been a trusted name in travel planning for years. Forward your booking emails, get an organized itinerary. Simple. But travel has evolved. And so have your needs. You want more than just flight times and hotel addresses. You want your passport, your insurance, your event tickets, all in one place. Protected. Accessible. Ready when you are.
              </p>

              <h2 className="pt-8 pb-0 px-0 font-semibold leading-9 text-[30px] text-[#0a0a0a] relative shrink-0 w-full whitespace-pre-wrap">
                What is TripIt and why look for alternatives
              </h2>

              <p className="font-normal leading-6 relative shrink-0 text-[#0a0a0a] text-base w-full whitespace-pre-wrap">
                TripIt is a travel organizer that creates itineraries from your booking confirmations. Forward an email. Get a trip timeline. It's been doing this well for years. Automatic itineraries organize forwarded booking emails. Calendar sync adds trips to your personal calendar. Flight alerts provide updates on delays and gate changes in the Pro version. Easy sharing sends itineraries to travel companions.
              </p>

              <p className="font-normal leading-6 relative shrink-0 text-[#0a0a0a] text-base w-full whitespace-pre-wrap">
                TripIt works. But it was built for a different era of travel. Modern travelers need more than itinerary management. TripIt doesn't store passports, IDs, or insurance documents. Real-time alerts require a paid subscription. The interface feels dated compared to newer apps. Security and encryption aren't the primary focus. You want an app that keeps everything together. Bookings and documents. Itinerary and identity. All protected with modern security.
              </p>
              ...
              <p className="font-normal leading-6 relative shrink-0 text-[#0a0a0a] text-base w-full whitespace-pre-wrap">
                Folio Wallet is a digital travel wallet. Not just an itinerary manager. A secure home for everything you need when you travel. Your flights and hotels. Your train tickets and event passes. Your passport and insurance. All in one beautiful, organized app.
              </p>

              <p className="font-normal leading-6 relative shrink-0 text-[#0a0a0a] text-base w-full whitespace-pre-wrap">
                Comprehensive storage keeps flights, trains, hotels, event tickets, IDs, passports, and insurance in one app. Not scattered across emails and folders. Timeline organization automatically arranges trips into an easy-to-follow timeline. You always know what comes next. Multiple upload options let you forward emails, upload PDFs, or snap photos. However you want to add documents, Folio handles it.
              </p>

              <p className="font-normal leading-6 relative shrink-0 text-[#0a0a0a] text-base w-full whitespace-pre-wrap">
                Secure sharing lets you create shared folders for family or group trips. Manage who sees what. Revoke access anytime. Offline access means you can open all your travel documents without internet. In the air. Underground. Anywhere. Real security includes AES-256 encryption, biometric authentication, and zero-knowledge architecture. Your data stays yours.
              </p>
              ...
              <p className="font-normal leading-6 relative shrink-0 text-[#0a0a0a] text-base w-full whitespace-pre-wrap">
                Choose TripIt if you only need basic itinerary management and don't mind keeping documents elsewhere. Choose <a href="/#get-the-app" className="underline hover:text-[#0a0a0a] transition-colors">Folio Wallet</a> if you want everything in one place: bookings, documents, tickets. All protected with real security. Travel is complicated enough. Your travel app shouldn't be.
              </p>
